...
namespace CarBook.WebApi.Controllers
{
    ...
    public class StatisticsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetBrandCGetCarCountByTransmissionIsAutoount()
        {
        ...
        public async Task<IActionResult> GetBlogTitlGetCarCountByFuelGasolineOrDieseleByMaxBlogComment()
        {
